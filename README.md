...
>A Scala implementation of the IAB Transparency and Consent Framework Consent String SDK.
This library supports the version v1.1 of the specification (version bit = 1).
...
Encode and decode base64 consent information with the IAB EU's GDPR Transparency and Consent Framework.

This library is a Scala reference implementation for dealing with consent strings in the IAB EU's GDPR Transparency and Consent Framework.
